...
const ASCII_BACKGROUND = Array.from({ length: 60 }, (_, row) =>
...
const testimonials = [
  {
    quote: "LedgerMind cut our expense report processing time by 80%. Our finance team can finally focus on strategy instead of data entry.",
    author: "Sarah Chen",
    role: "CFO",
    company: "Meridian Labs",
    metric: { value: "80%", label: "Time saved" },
  },
  {
    quote: "The AI categorization is incredibly accurate. We went from hours of manual tagging to fully automated expense tracking.",
    author: "Marcus Webb",
    role: "Head of Finance",
    company: "Flux Systems",
    metric: { value: "10x", label: "Faster processing" },
  },
  {
    quote: "Real-time spending dashboards changed how we budget. We caught $40K in duplicate charges in the first month alone.",
    author: "Elena Rodriguez",
    role: "VP Operations",
    company: "Beacon AI",
    metric: { value: "$40K", label: "Saved in month 1" },
  },
  {
    quote: "Bank-level encryption and full audit trails. Our compliance team was fully on board from day one.",
    author: "James Liu",
    role: "CISO",
