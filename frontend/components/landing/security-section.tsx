...
const securityFeatures = [
  {
    ...
    description: "Each company's data is processed in its own secure environment.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Encrypted storage",
    description: "Financial data encrypted at rest and in transit with AES-256.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full audit trails",
    description: "Every transaction and action logged and fully inspectable.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Role-based access",
    description: "Granular permissions ensure teams see only what they need.",
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your financial data deserves enterprise-grade protection. Bank-level security ensures it stays safe.
            </p>
          </div>
        </div>
