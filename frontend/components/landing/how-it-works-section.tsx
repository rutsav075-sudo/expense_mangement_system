...
const steps = [
  {
    number: "01",
    title: "Capture",
    subtitle: "your receipts",
    description: "Snap a photo, forward an email, or connect your bank. LedgerMind ingests expenses from any source automatically.",
    code: `ledgermind.capture({
  source: 'email-forward',
  merchant: 'auto-detect',
  ...
  },
  {
    ...
    title: "Analyze",
    subtitle: "& categorize",
    description: "AI instantly categorizes each expense, matches it against your policies, and flags anomalies for review.",
    code: `await ledgermind.analyze({
  expense: receipt,
  policy: 'company-default',
  flags: ['over-budget', 'duplicate'],
  ...
  },
  {
    ...
    title: "Optimize",
    subtitle: "& report",
    description: "Get real-time dashboards, monthly reports, and actionable recommendations to cut unnecessary spending.",
    code: `ledgermind.dashboard({
  views: ['by-category', 'by-team'],
  metrics: ['spend', 'savings', 'trends'],
  alerts: true
})
// $12,340 saved this quarter`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Save.</span>
            </h2>
          </div>
